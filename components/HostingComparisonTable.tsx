...
const rows = [
  ...
  { label: "Who’s bringing what", values: ["Who’s Bringing What — included in Free", unverified, "SignUp Sheets", unverified] },
  ...
  { label: "Readiness score", values: ["HostReady — included in Free", unverified, unverified, unverified] },
