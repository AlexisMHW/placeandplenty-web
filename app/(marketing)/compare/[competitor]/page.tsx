  ...
  return <>
    ...
    <div className="mx-auto max-w-editorial px-6 py-12 md:py-16">
      ...
      <section className="grid gap-8 md:grid-cols-2" aria-label="Which tool fits your gathering?">
        ...
        <div className="rounded-card border border-gold bg-cream p-7"><h2 className="font-display text-3xl text-forest">Where P&amp;P fits</h2><p className="mt-4 leading-relaxed">Choose P&amp;P when you want a home for the preparation as well as the invitation. My Table, My Shopping List, My Hosting Closet and your timeline help organize the work before people arrive.</p><p className="mt-4 leading-relaxed">HostReady provides a readiness score on Free, Gathering Pass and Plus. The point is to help you see what still needs attention while there is time to do something about it.</p><Link href="/what-it-does" className="mt-4 inline-block text-sm underline underline-offset-4">Explore P&amp;P’s features</Link></div>
      </section>
