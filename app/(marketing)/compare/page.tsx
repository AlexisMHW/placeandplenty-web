...
const title = "P&P vs. Evite, Paperless Post & Partiful";
const description = "Compare Place & Plenty, Evite, Paperless Post and Partiful in one table: invitations, RSVPs, contributions, menus, shopping, readiness and pricing.";
